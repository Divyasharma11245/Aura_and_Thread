...
<body>
    <h3 id="heading">Hi, ${name}</h3>
    <div id="box">
        <h4>Here is your OTP for your password reset:</h4>
    ...
    <p>You're receiving this email because a reset password request code was requested for your account. <br>
